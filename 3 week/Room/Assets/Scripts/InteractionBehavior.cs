...
//Логику изменнеия свойство объекта лучше оберунть в методы внутри объекта
    ...
    {		
		...
		//this changes move to InteractibleItem script which is on every item
        _currentGameObject.transform.localPosition = new Vector3(0, 0, 0); //.zero
